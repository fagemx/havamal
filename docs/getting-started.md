...
- execution state — when a long-running campaign outgrows the state snapshot, use [edda](https://github.com/fagemx/edda) (state management is software's job, not markdown's; old method in `docs/archive/`).
